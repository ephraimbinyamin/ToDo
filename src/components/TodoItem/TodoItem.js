...
const TodoItem = ({index , id , text , isChecked}) => {
    ...
    const unchecked = (
        <svg className="todoItem__task_btn-checkbox_icon todoItem__task_btn-checkbox_icon-unchecked" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="3 3 18 18" fill="#000">
            <path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/>
        </svg>
    );

    const checked = (
        <svg className="todoItem__task_btn-checkbox_icon todoItem__task_btn-checkbox_icon-checked" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="3 3 18 18" fill="#000"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14z"/>
    ...
    return (
        <li className="todoItem">
            <div className="task todoItem__task" tabIndex="0"
                ...
                <div className={`task todoItem__task_text ${isChecked ? "todoItem__task_text-crossed" : null}`}>{text}</div>
